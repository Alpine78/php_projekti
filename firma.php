          ...
          <?php
            ...
            if ( !$tulos )
            {
              ...
              if (mysqli_num_rows($tulos) == 0) {
                ...
                $kustannusarvio = "";
                $status = "";
                echo "<table class=\"table\"><thead><tr><th scope=\"col\">Tilaaja</th><th scope=\"col\">Postitoimipaikka</th><th scope=\"col\">Asunnontyyppi</th><th scope=\"col\">Työnkuvaus</th><th scope=\"col\">Tilauspvm</th><th scope=\"col\">Työtunnit</th><th scope=\"col\">Kustannusarvio</th><th scope=\"col\">Status</th><th scope=\"col\"></th></tr></thead><tbody>";
